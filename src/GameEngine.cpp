...
namespace Engine {
	...
	void GameEngine::Start( const std::string& firstSceneName, int fps, int screenW, int screenH, int reserveSamples, const char* title, const char* icon) {
	...
	int GameEngine::GetScreenFullWidth() const{
		return displayMode.width;
	}
	
	int GameEngine::GetScreenFullHeight() const{
